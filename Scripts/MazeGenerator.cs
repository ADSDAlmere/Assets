...
public class MazeGenerator : MonoBehaviour
{
    ...
    public void MakeExit()
    {
        ...
        if (newCell.gridPos.x == 0) SetExitWall(newCell.cScript, 1);
        else if (newCell.gridPos.x == mazeColumns) SetExitWall(newCell.cScript, 2);
        else if (newCell.gridPos.y == mazeRows) SetExitWall(newCell.cScript, 3);
        else SetExitWall(newCell.cScript, 4);
    ...
    public void RemoveWall(CellScript cScript, int wallID)
    {
        switch (wallID)
        {
            case 1: cScript.wallL.SetActive(false); break;
            case 2: cScript.wallR.SetActive(false); break;
            case 3: cScript.wallU.SetActive(false); break;
            case 4: cScript.wallD.SetActive(false); break;
        }
    }
    public void SetExitWall(CellScript cScript, int wallID)
    {
        Renderer render = null;
        switch (wallID)
        {
            case 1: render = cScript.wallL.GetComponent<Renderer>(); break;
            case 2: render = cScript.wallR.GetComponent<Renderer>(); break;
            case 3: render = cScript.wallU.GetComponent<Renderer>(); break;
            case 4: render = cScript.wallD.GetComponent<Renderer>(); break;
        }
